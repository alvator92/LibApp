...
alter table book ADD CONSTRAINT fk_book_person FOREIGN KEY (person_id) REFERENCES person (id);


insert into person (name, age, email, address) values('Jel', 62, 'jel@mail.ru', 'Russia, Moscow, 123456');
insert into person (name, age) values('Fixer', 42);
...
CREATE TABLE movie (
	movie_id int4 NOT NULL GENERATED BY DEFAULT AS identity primary key ,
	"name" varchar(200) NOT NULL,
	year_of_production int4 CHECK (year_of_production > 1900)
);
